...
public class ParseFile {
    ...
    public static Location parseChests(List<String> chest) {
        Bukkit.getConsoleSender().sendMessage("§cAppel de ParseChests");
        if (chest.size() < 2) {
            return null;
        }

        Location locate_chest = null;

        try {
        	
                //locate_chest = new Location();
